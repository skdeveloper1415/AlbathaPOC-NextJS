                ...
                <div className="justify-content-center px-1 space-y-1">
                    ...
                    <div className="space-y-1 py-1">
                        <div className="text-[16px] xl:text-[0.833vw] text-[#344054] font-medium mb-[8px]">
                            Tags</div>
                        <div className="card flex justify-content-center custInput inputPadding">
                            <InputText value={tags} onChange={(e) => { setTags(e.target.value) }} placeholder="Type here" className="w-full md:w-14rem" />
                        </div>
                    </div>
                    <div className="space-y-1 py-1">
                        <div className="text-[16px] xl:text-[0.833vw] text-[#344054] font-medium mb-[8px]">
                            Region</div>
                        <div className="card flex justify-content-center custDropdown inputPadding">
                            <Dropdown 
                                value={region}
